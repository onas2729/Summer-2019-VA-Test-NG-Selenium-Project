...
public class ExtentDemoTest {
    // this class is used for starting and building the reports
    ...
    public void setUp(){
        ...
        report.setSystemInfo("whats my name", "John B Good Enough");
    ...
    public void test1(){
        ...
        extentLogger=report.createTest("TC001 Login as a driver test");
